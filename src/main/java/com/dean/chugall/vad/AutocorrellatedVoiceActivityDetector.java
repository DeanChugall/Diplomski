 ...
 *
 */
package com.dean.chugall.vad;

import java.util.Arrays;

/**
 * A voice activity detector attempts to detect presence or absence of voice in the signal.
 * <p>
 * The technique used here is a simple (but efficient) one based on a characteristic of (white) noise :
 * when applying autocorrelation, the mean value of the computed coefficients gets close to zero. <br/>
